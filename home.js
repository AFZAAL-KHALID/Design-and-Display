...
function category() {
    ...
    var theme =[
    { cate: "School Start"} , { cate: "ethnic"},{ cate: "mr man"},{ cate: "monotones"},{ cate: "check and stripe"},{ cate: "geometrical"},{ cate: "bold and bloom"},{ cate: "dear romance"},{ cate: "blue haze"},{ cate: "jaipur"},{ cate: "check and stripe"},{ cate: "geomatical"},
]

theme.forEach(element => {
    var newCategory = ` <h1 class="singleCategory    transition-colors duration-0.3 ease-in-out    w-auto inline-block     text-[2rem] capitalize p-4 rounded-full bg-[#f28482] cursor-pointer hover:shadow-xl hover:bg-[#f56765]">${element.cate}
    </h1>`;
...
// theme change
        ...
        
        {
            name: "BLOCK PRINT  10 ",
            theme: "jaipurmail2",
            Image: `src="./assets/products/themejaipurmail2/.jpg"` ,
            price: "786",
        },
        {
            name: " BLOCK PRINT 12",
    ...
    singleExpand.addEventListener("click", function (e) {
      ...
      if (e.target.classList.contains("addtoCart")) {
          ...
          var ShowData = document.querySelector(".ShowData");
            ...
            <h1 class="cartItemName     text-1rem md:text-[2rem] text-wrap">${singleExpand.querySelector(".productName").innerText}</h1>
...
function matchCategory() {
    ...
    matchArray.forEach(word => {
        word.addEventListener("click", function () {
            word.style.backgroundColor = "rgb(58, 57, 57)";
            ...
            setTimeout(() => {
                word.style.backgroundColor = "#f28482";
            ...
            filteredArray.forEach(filteredElem => {
                blankArray += `<div class="againproductDetails  relative flex-shrink-0 w-[24rem] sm:w-[22rem] h-[40rem] font-sans uppercase font-bold p-2 text-[2rem] sm:text-[1.5vw] bg-[#f2e9e4] flex gap-2 flex-col justify-around items-center hover:border-gray-700 hover:border-[3px] hover:shadow-2xl">
                <span class="material-symbols-outlined absolute right-0 top-0 cursor-pointer ">pan_zoom</span>
...
// background pink keley when click on cate product name
            ...
            var againproductDetails = document.querySelectorAll(".againproductDetails");
